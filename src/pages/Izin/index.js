...
export default function PengajuanIzin({ navigation }) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.white }}>
      <View style={{ padding: 10 }}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <View style={{ flexDirection: 'row', padding: 10, justifyContent: 'flex-start', alignItems: 'center' }}>
            ...
            <Text style={{ fontFamily: fonts.primary[600], fontSize: 15, top: 2 }}>Pengajuan Surat Izin / Sakit</Text>
          </View>
        </TouchableOpacity>
      </View>
      ...
      <ScrollView>
        <View style={{ padding: 10 }}>
          <View>
            <MyPicker iconname="list-outline" label="Pilih Tipe Izin" />
